...
This section contains instructions for accomplishing tasks manually in case you do not have access to the required CLI tools or want to perform the tasks manually for some other reason.

### (Backup Instructions) Manually Forking the application code repository demo application
...
### (Backup Instructions} Manually Forking the ops repository for the demo application
